...
class SchoolInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<CubitClass, SchoolStates>(
        listener: (context, states) {},
        builder: (context, states) {
          var cubit = CubitClass.get(context);
          return Scaffold(
            appBar: AppBar(
              toolbarHeight: 120,
            ...
            body: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  reusableTextField(cubit.schoolName, Icons.school),
                  const SizedBox(
                    height: 15,
                  ),
                  reusableTextField(cubit.schoolAddress, Icons.location_on_rounded),
                  const SizedBox(
                    height: 15,
                  ),
                  reusableTextField(cubit.studentsNo, Icons.person),
                  const SizedBox(
                    height: 15,
                  ),
                  reusableTextField(cubit.teachersNo, Icons.person),
                  Padding(
